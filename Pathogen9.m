...
Istate = [zeros(2,nBeds);.0 0 0 0 0 0 0 0 .1*State_Sub9(3,9)];
...
MS_a = [0 0 0; .19*(1/fecS) pS_surv*(11/12) 0; 0 pS_surv*1/12 pS_surv*1]; %aging matrix for sus pop
MI_a = [0 0 0; (.19-reduction*.19)*(1/fecS) pI_surv*(11/12) 0; 0 pI_surv*1/12 pI_surv*1]; %aging matrix for inf pop
